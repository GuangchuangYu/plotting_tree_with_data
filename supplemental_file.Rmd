...
```{r md, echo=F, fig.width=9.5, fig.height=6.2, warning=FALSE, message=FALSE, fig.cap="\\label{fig:md}Example of attaching multiple datasets and labelling taxa with image files", dev="CairoPNG", dpi=200, out.width="85%"}
library(ggimage)
library(ggtree)
...
**NOTE:** source code that produces this file can be obtained online^[<https://github.com/GuangchuangYu/plotting_tree_with_data>].
